...
# installed directory.
NSF_INCLUDE_DIR="/tmp/ActiveState------------------------------------------please-run-the-install-script-----------------------------------------/include"
...
# String to pass to linker to pick up the nsf library from its
# installed directory.
NSF_LIB_SPEC='-L/tmp/ActiveState------------------------------------------please-run-the-install-script-----------------------------------------/lib/nsf2.1.0 -lnsf2.1.0'
...
# String to pass to linker to pick up the NSF stub library from its
# installed directory.
NSF_STUB_LIB_SPEC='-L/tmp/ActiveState------------------------------------------please-run-the-install-script-----------------------------------------/lib/nsf2.1.0 -lnsfstub2.1.0'
...
NSF_STUB_LIB_PATH='/tmp/ActiveState------------------------------------------please-run-the-install-script-----------------------------------------/lib/nsf2.1.0/libnsfstub2.1.0.a'
...
NSF_COMPATIBLE_TCLSH=/tmp/ActiveState------------------------------------------please-run-the-install-script-----------------------------------------/bin/tclsh8.6
