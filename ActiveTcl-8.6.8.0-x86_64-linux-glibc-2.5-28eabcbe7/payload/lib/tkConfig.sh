...
TK_LIBS='-L/usr/lib64 -lX11 -lXss -lXext -lXft -lXrender -lfontconfig -lfreetype -lX11   -lfontconfig  -lpthread -ldl -lz  -lpthread -lieee -lm'

# Top-level directory in which Tk's platform-independent files are
# installed.
TK_PREFIX='/tmp/ActiveState------------------------------------------please-run-the-install-script-----------------------------------------'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/tmp/ActiveState------------------------------------------please-run-the-install-script-----------------------------------------'

# -I switch(es) to use to make all of the X11 include files accessible:
TK_XINCLUDES=''

# Linker switch(es) to use to link with the X11 library archive.
TK_XLIBSW='-L/usr/lib64 -lX11 -lXss -lXext'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/tmp/---warning-do-not-use----/Tk/unix/linux-shared -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/tmp/ActiveState------------------------------------------please-run-the-install-script-----------------------------------------/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/tmp/ActiveState------------------------------------------please-run-the-install-script-----------------------------------------/include'
...
# compiled.
TK_SRC_DIR='/tmp/---warning-do-not-use----/Tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/tmp/---warning-do-not-use----/Tk/unix/linux-shared -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/tmp/ActiveState------------------------------------------please-run-the-install-script-----------------------------------------/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/tmp/---warning-do-not-use----/Tk/unix/linux-shared/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/tmp/ActiveState------------------------------------------please-run-the-install-script-----------------------------------------/lib/libtkstub8.6.a'
