...
ActiveState ActiveTcl 8.6.8.0                                              Sep 28 2018
_____________________________________________________________________________
...
Installing ActiveTcl 8.6.8
_____________________________________________________________________________

To install ActiveTcl 8.6.8, run the "install.sh" script found in the
...
Contents of ActiveTcl 8.6.8
_____________________________________________________________________________

ActiveTcl Build 8.6.8 is based on the @tcltkpver@ version of Tcl. The
