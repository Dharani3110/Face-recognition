...
proc vTcl:setup {} {
    ...
    set LIBS            "globals.tcl about.tcl propmgr.tcl balloon.tcl
             ...
             callback.tcl apply.tcl tooltip.tcl"
...
#trace add variable vTcl(actual_gui_font_tooltip_name) \
    write "tracer vTcl(vTcl(actual_gui_font_tooltip_name)"

# namespace eval ::widgets::.top42.but43 { }
# trace add variable ::widgets::.top42.but43::options \
#     write "tracer ::widgets::.top42.but43::options"
