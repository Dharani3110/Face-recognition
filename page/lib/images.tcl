...
# dpr filename
# dpr reference
# dpr ::vTcl(images,$reference,image)
# dpr ::vTcl(images,$reference,description)
# dpr ::vTcl(images,$reference,type)
# dpr  ::vTcl(images,filename,$object)
...
proc vTcl:prompt_user_image2.no {image} {
    ...
    if {$r == "<new>"} {
        ...
        set r [vTcl:image:new_image_file {} "user"]
    } elseif {$r == "<cancel>"} {
...
proc vTcl:image:dump_create_image_footer {} {
    ...
    append result "# from vTcl:image:dump_create_image_footer\n"

    # append result " \
    # eval set _file \[lindex \$img 0\]
    # lappend img_list \[vTcl:image:create_new_image\
...
proc vTcl:image:generate_image_user {fileID} {
    ...
    puts $fileID {#############################################################################}
    puts $fileID "\#\# vTcl Code to Load User Images see vTcl:save2 in file.tcl\n"
