...
# proc vTcl:button2_click_tree {widget} {
#     # Come here when a widget is selected with Button2.
# dmsg
# dpr widget
# }
...
proc vTcl:init_wtree {{wants_destroy_handles 1}} {
    ...
    foreach ii $tree {
        ...
        #set alt_button3_cmd "vTcl:alt_b3_click_tree $i";# For showing callbacks
        #bind $b.$j <Alt-Button-3> $alt_button3_cmd      ;# For showing callbacks
