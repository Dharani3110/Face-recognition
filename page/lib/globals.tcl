...
set vTcl(geometry,.vTcl.toolbar) +0+140
...
set vTcl(geometry,.vTcl.apply) -0-0
set vTcl(geometry,.vTcl.callback) -0-0
set vTcl(geometry,.vTcl.gui_console) +0+100      ;# NEEDS DUP
set vTcl(geometry,.vTcl.supp_console) -0+100      ;# NEEDS DUP
...
#set vTcl(default,.vTcl.gui_console) +500+100
