...
#    Mar 14, 2019 03:36:44 PM IST  platform: Linux
...
class second_win_Yes:
    def __init__(self, top=None):
        ...
        self.eggCount = tk.Spinbox(self.veggies, from_=1.0, to=10.0)
        ...
        self.eggCount.configure(textvariable=second_win_support.eggC)

        self.chocolates = tk.LabelFrame(top)
        self.chocolates.place(relx=0.333, rely=0.176, relheight=0.221
                , relwidth=0.235)
        ...
        self.kitkatCount = tk.Spinbox(self.chocolates, from_=1.0, to=10.0)
        ...
        self.kitkatCount.configure(textvariable=second_win_support.kitkatC)

        self.soups = tk.LabelFrame(top)
        self.soups.place(relx=0.587, rely=0.176, relheight=0.25, relwidth=0.313)
        ...
        self.vegSCount = tk.Spinbox(self.soups, from_=1.0, to=10.0)
        ...
        self.vegSCount.configure(textvariable=second_win_support.vegSC)

        self.nvegSCount = tk.Spinbox(self.soups, from_=1.0, to=10.0)
        ...
        self.nvegSCount.configure(textvariable=second_win_support.nvegSC)

        self.Message1 = tk.Message(top)
        self.Message1.place(relx=0.176, rely=0.0, relheight=0.176
                , relwidth=0.585)
        ...
        self.cancelPantry.place(relx=0.568, rely=0.824, height=28, width=68)
        ...
        self.Next.place(relx=0.724, rely=0.824, height=28, width=75)
        self.Next.configure(activebackground="#f9f9f9")
        self.Next.configure(command=second_win_support.next)
        self.Next.configure(text='''Confirm''')
